            ...
            <div class="d-flex mr-auto header-right-icons header-search-icon">
                ...
                <div class="dropdown profile-1">
                    <a href="#" data-toggle="dropdown" class="nav-link pl-2 pr-2  leading-none d-flex">
									<span>
										<img src="{{asset('assets/admin')}}/images/users/10.jpg" alt="profile-user" class="avatar  ml-xl-3 profile-user brround cover-image">
									</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                        ...
                        <a class="dropdown-item" href="https://laravel.spruko.com/yoha/Sidemenu-Icon-Light-rtl/login">
