...
<h2 class="MainTitle mb-5 ms-4">ticket</h2>
      <div class="multisteps-form">
        <form action="family-access.html" class="row">
          <div class="col-lg-9 p-1 ">
            <div class="multisteps-form__progress mb-5">
              <button type="button" class="multisteps-form__progress-btn js-active" title="ticket"> ticket </button>
          ...
          <div class=" col-lg-3 p-1 ">
            <div class=" bill">
              ...
              <img src="{{asset('admin')}}/img/barcode.jpg" class="barcode">
              <div class="printBtn">
