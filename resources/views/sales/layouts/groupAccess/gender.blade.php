<div class="choose" id="mainGenderDiv{{$model->id}}">
    <div class="genderOption">
        <input type="radio" class="btn-check gender" name="gender{{$model->id}}" value="male" id="option1{{$model->id}}">
        <label class=" mb-0 btn btn-outline" for="option1{{$model->id}}">
            <span> <i class="fas fa-male"></i> </span>
        </label>
    </div>
    <div class="genderOption">
        <input type="radio" class="btn-check gender" name="gender{{$model->id}}" value="female" id="option2{{$model->id}}">
