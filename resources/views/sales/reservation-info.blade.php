        ...
        <form  action="{{route('reservations.update',$id)}}" method="POST" enctype="multipart/form-data" class="row">
          @csrf
            ...
            <div class="multisteps-form__form mb-2">
              <!-- step 1 -->
              <div class="card multisteps-form__panel ReservationInfo-multisteps-form__panel p-3 border-radius-xl bg-white js-active" validate="true" id="ticketTab" data-animation="FadeIn">
                ...
                <div class="multisteps-form__content">
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-12 p-2">
                      ...
                      <textarea name="notes" id="" class="form-control" rows="6" placeholder="Add Note..."></textarea>
                    </div>
                  </div>
                  <div class="button-row d-flex mt-4">
                    <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" data-title="visitors" data-active="ReservationInfo" type="button"
                            id="firstNext">Next</button>
                  </div>
                </div>
              </div>
                <!-- step 2 -->
                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white " id="visitorsTab"
                    ...
                    <div class="multisteps-form__content">
                        <div class="row mt-3">
                            <!-- visitor Type  -->
                            <small class="form-text text-muted mb-1"><i class="fa fa-arrow-right text-warning"></i> Enter a number to add many rows</small>
                                ...
                                @foreach($types as $type)
                                    <div class="visitorType visitorType{{$type->id}}">
                                        ...
                                        <div class="countInput">
                                            <input type="number" id="countInput" class="inputCount" min="0" value="0" />
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="col-2">
                                <button class="btn btn-danger" type="button" onclick="DeleteRows()"><i class="fal fa-trash me-2"></i> Clear</button>
                            </div>
                            <!-- table -->
