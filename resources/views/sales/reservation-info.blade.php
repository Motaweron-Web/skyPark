                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-12 p-2">
                      ...
                      <div class="visitorType visitorType{{$visitorType->id}}" data-id="{{$visitorType->id}}">
                        ...
                        <span class="visitor" data-id="{{$visitorType->id}}"> {{$visitorType->title}} </span>
{{--                          <span class="count">1</span>--}}
                    ...
                    <div class="col-12 p-2 position-relative">
                      <table style="height: 200px; overflow-x: auto" class=" customDataTable  table table-bordered nowrap">
                        <thead>
                          <tr>
                            <th>Type</th>
                            <th>price </th>
          ...
          <div class=" col-lg-3 p-1 ">
            <div class=" bill">
              ...
              <div class="info">
                <h6 class="billTitle"> ticket <span> #{{$customId}}</span> </h6>
                <ul>
