...
@section('title') Sky Park | Offers @endsection
@section('page_name') Offers @endsection
@section('css')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Sky Park Offers</h3>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered text-nowrap w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="min-w-50px">associated items</th>
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('offers.index')}}', columns);
        deleteScript('{{route('offer.delete')}}');

        // Get Edit View
        $(document).on('click', '.editBtn', function () {
            var id = $(this).data('id')
            var url = "{{route('offers.edit',':id')}}";
        ...
        $(document).on('click', '.addBtn', function () {
            ...
            $('#editOrCreate').modal('show')
            setTimeout(function () {
                $('#modalContent').load('{{route('offers.create')}}')
            }, 250)
        });
