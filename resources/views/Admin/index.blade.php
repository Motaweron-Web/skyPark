            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5 fs-12">
                        <div class="float-right ml-3"><span class="dot-label bg-primary ml-1"></span><span class="">Mens</span></div>
                        <div class="float-right ml-3"><span class="dot-label bg-secondary ml-1"></span><span class="">Womens</span></div>
                        <div class="float-right ml-3"><span class="dot-label bg-secondary1 ml-1"></span><span class="">Kids</span></div>
                        <div class="float-right ml-3"><span class="dot-label bg-canvas1 ml-1"></span><span class="">Electronics</span></div>
                        <div class="float-right"><span class="dot-label bg-canvas2 ml-1"></span><span class="">Home & Furniture</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <div class="mb-5">
                        <p class="mb-2">Total Profit<span class="float-left"><b>51,234</b><span class="text-muted mr-1">(80%)</span></span></p>
                        <div class="progress h-2">
                            <div class="progress-bar bg-primary w-80 " role="progressbar"></div>
                        </div>
                    </div>
                    <div class="mb-5">
                        <p class="mb-2">Total Income<span class="float-left"><b>12,786</b><span class="text-muted mr-1">(50%)</span></span></p>
                        <div class="progress h-2">
                            <div class="progress-bar bg-secondary w-50 " role="progressbar"></div>
                        </div>
                    </div>
                    <div class="mb-0">
                        <p class="mb-2">Total Expenses<span class="float-left"><b>32,167</b><span class="text-muted mr-1">(60%)</span></span></p>
                        <div class="progress h-2">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-5">
                        <p class="mb-1 d-flex">
                            <span class=""><i class="fa fa-money text-muted ml-2 mt-1 fs-16"></i></span>
                            <span class="fs-13 font-weight-normal text-muted ml-2">Received Amount </span> : <span class="mr-auto fs-14">+ 1,50,500</span>
                        </p>
                        <p class="mb-1 d-flex">
                            <span class=""><i class="fa fa-credit-card ml-2 mt-1 fs-16 text-muted"></i></span>
                            <span class="fs-13 font-weight-normal text-muted ml-2">Sent Amount </span> : <span class="mr-auto fs-14">- 25,500</span>
                        </p>
                        <p class="d-flex">
                            <span class=""><i class="fa fa-university ml-2 fs-16 text-muted"></i></span>
                            <span class="fs-13 font-weight-normal text-muted ml-2">Total Amount </span> : <span class="mr-auto font-weight-bold fs-15">$ 1,00,500</span>
                        </p>
                    </div>
                    <div class="row mt-3">
                        <div class="col-6">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-nowrap mb-0">
                            ...
                            <tr>
                                <td>
                                    <img src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/3.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                    Vashti Riccio
                                </td>
                                <td>#89345</td>
                                <td>Sport Shooes</td>
                            ...
                            <tr>
                                <td>
                                    <img src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/4.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                    Harriett Lauver
                                </td>
                                <td>#39281</td>
                                <td>T-Shirt</td>
                            ...
                            <tr>
                                <td>
                                    <img src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/5.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                    Darci Faw
                                </td>
                                <td>#35825</td>
                                <td>Hand Bag</td>
                            ...
                            <tr>
                                <td>
                                    <img src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/6.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                    Jamie Norville
                                </td>
                                <td>#62391</td>
                                <td>Lather Watch</td>
                            ...
                            <tr>
                                <td>
                                    <img src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/7.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                    Danae Kaba
                                </td>
                                <td>#92481</td>
                                <td>Laptop</td>
                            ...
                            <tr>
                                <td>
                                    <img src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/8.jpg" alt="profile-user" class="brround  avatar-sm w-32 ml-2">
                                    Jeromy Tricarico
                                </td>
                                <td>#29381</td>
                                <td>Office Chair</td>
                ...
                <div class="card-body">
                    <div class="activity-block">
                        <ul class="task-list user-tasks">
                            <li>
                                <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/1.jpg"></span>
                                <h6>Successful Purchase<small class="float-left text-muted tx-11">29 Mar 2020</small></h6>
                                <span class="text-muted tx-12">Order ID: #4567</span>
                            </li>
                            <li>
                                <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/2.jpg"></span>
                                <h6>New Registered Seller<small class="float-left text-muted tx-11">25 Mar 2020</small></h6>
                                <span class="text-muted tx-12">User ID: #8976</span>
                            </li>
                            <li>
                                <span class="avatar avatar-md brround cover-image task-icon1 bg-pink">H</span>
                                <h6>Order Verification<small class="float-left text-muted tx-11">14 Feb 2020</small></h6>
                                <span class="text-muted tx-12">Order ID: #6290</span>
                            </li>
                            <li>
                                <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/8.jpg"></span>
                                <h6>New Item Added<small class="float-left text-muted tx-11">02 Feb 2020</small></h6>
                                <span class="text-muted tx-12">Item ID: #0235</span>
                            </li>
                            <li>
                                <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/9.jpg"></span>
                                <h6>Purchase Cancellation<small class="float-left text-muted tx-11">28 Jan 2020</small></h6>
                            ...
                            <li class="mb-0">
                                ...
                                <h6>Overdue Shipments<small class="float-left text-muted tx-11">25 Jan 2020</small></h6>
            ...
            <div class="card">
                ...
                <div class="customer-scroll">
                    <div class="list-group-item d-flex  align-items-center border-top-0 border-left-0 border-right-0">
                        <div class="ml-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/1.jpg"></span>
                        </div>
                        <div class="">
                    ...
                    <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
                        <div class="ml-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/13.jpg"></span>
                        </div>
                        <div class="">
                    ...
                    <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
                        <div class="ml-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/14.jpg"></span>
                        </div>
                        <div class="">
                    ...
                    <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
                        <div class="ml-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/6.jpg"></span>
                        </div>
                        <div class="">
                    ...
                    <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
                        <div class="ml-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/3.jpg"></span>
                        </div>
                        <div class="">
                    ...
                    <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
                        <div class="ml-2">
                            <span class="avatar avatar-md brround cover-image" data-image-src="https://laravel.spruko.com/yoha/Sidemenu-Icon-Dark-rtl/assets/images/users/7.jpg"></span>
                        </div>
                        <div class="">
