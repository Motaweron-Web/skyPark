...
@section('title') Sky Park | References @endsection
@section('page_name') References @endsection
@section('css')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Sky Park References</h3>
                    <div class="">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('reference.index')}}', columns);
        deleteScript('{{route('reference.delete')}}');
        ...
        $(document).on('click', '.addBtn', function () {
            ...
            $('#editOrCreate').modal('show')
            setTimeout(function () {
                $('#modalContent').load('{{route('reference.create')}}')
            }, 250)
        });
